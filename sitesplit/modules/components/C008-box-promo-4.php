...
<div class="promo <?php echo $styleClassName ?>" tabindex="0">
		...
		<div class="copy-wrapper">
			...
			<!-- SNIPPET -->
			<div class="snippet">
				<p>Our success in wealth management is built on the personal relationship between each client and their private banker. ur success in wealth management is built on the personal relationship between each client and their private banker. ur success in wealth management is built on the personal relationship between each client and their private banker</p>
			</div>
